...
\date{June 2026 \quad(\texttt{pcf-delta} v1.1 draft)}
...
monotone--bounded convergence $R_n\to\Rinf$, and the closed-form bracket
$1+S\le\Rinf\le1/(1-S)$ --- is machine-checked in Lean~4/Mathlib
...
\begin{proposition}[Cluster closed forms; \textsc{structural}
